...
template_fpath=$PROJ_DIR/scripting/autofig/alg_synbindec/alg_synbindec_template1.ai
template_linkdir=$PROJ_DIR_TILDE/scripting/autofig/alg_synbindec/template1_images

# Log file
logfpath=$PROJ_DIR/scripting/logs/log_alg_synbindec.txt
echo "Log" > $logfpath
