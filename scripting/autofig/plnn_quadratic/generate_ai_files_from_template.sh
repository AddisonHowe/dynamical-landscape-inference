...
template_fpath=$PROJ_DIR/scripting/autofig/plnn_quadratic/plnn_quadratic_template1.ai
template_linkdir=$PROJ_DIR_TILDE/scripting/autofig/plnn_quadratic/template1_images

# Log file
logfpath=$PROJ_DIR/scripting/logs/log_plnn_quadratic.txt
echo "Log" > $logfpath

# This is where all generated ai files will be stored, one for every run below.
aioutdir=${PROJ_DIR}/figures/autofig/out/plnn_quadratic
mkdir -p $aioutdir
...
tmp_script_fpath=$PROJ_DIR/scripting/autofig/plnn_quadratic/_tmp_modify_links.jsx

# Directories containing images corresponding to trained models.
RUNDIRBASE=data/model_evaluation/eval_models_plnn_quadratic
