...
#=============================================================================
#
# FILE: run_model_testing_facs_dec1_v1_argset1.sh
#
# USAGE: run_model_testing_facs_dec1_v1_argset1.sh
#
# DESCRIPTION: Run the model testing script on all model_facs_dec1_v1 models 
#  against testing data.
#
# EXAMPLE: sh run_model_testing_facs_dec1_v1_argset1.sh
#=============================================================================
...
modeldirs=$(ls -d $basedir/model_facs_dec1_v1_argset1_*)
