...
#=============================================================================
#
# FILE: run_model_testing_facs_dec2_v3.sh
#
# USAGE: run_model_testing_facs_dec2_v3.sh
#
# DESCRIPTION: Run the model testing script on all model_facs_dec2_v3 models 
#  against testing data.
#
# EXAMPLE: sh run_model_testing_facs_dec2_v3.sh
#=============================================================================
...
modeldirs=$(ls -d $basedir/model_facs_dec2_v3_*)
