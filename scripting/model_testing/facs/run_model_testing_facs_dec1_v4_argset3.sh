...
#=============================================================================
#
# FILE: run_model_testing_facs_dec1_v4_argset3.sh
#
# USAGE: run_model_testing_facs_dec1_v4_argset3.sh
#
# DESCRIPTION: Run the model testing script on all model_facs_dec1_v4 models 
#  against testing data.
#
# EXAMPLE: sh run_model_testing_facs_dec1_v4_argset3.sh
#=============================================================================
...
modeldirs=$(ls -d $basedir/model_facs_dec1_v4_argset3*)
