...
#=============================================================================
#
# FILE: run_model_testing_facs_dec2_v2.sh
#
# USAGE: run_model_testing_facs_dec2_v2.sh
#
# DESCRIPTION: Run the model testing script on all model_facs_dec2_v2 models 
#  against testing data.
#
# EXAMPLE: sh run_model_testing_facs_dec2_v2.sh
#=============================================================================
...
modeldirs=$(ls -d $basedir/model_facs_dec2_v2_*)
