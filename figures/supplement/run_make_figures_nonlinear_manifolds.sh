...
python figures/supplement/make_figure_nonlinear_manifolds_overview.py \
...
# python figures/supplement/make_figure_saddle_bcd_parameterization1.py \
#     -o $o1 -k1 $k11 -k2 $k21 -m $model1 \
#     -ul -2 2 -vl -2 2 -xl -3 3 -yl -3 3
...
# python figures/supplement/make_figure_saddle_bcd_parameterization2.py \
#     -o $o1 -k1 $k11 -k2 $k21 -m $model1 \
