"""Motivating example for latent space dynamics
...
OUTDIR = f"figures/supplement/out/nonlinear_manifolds/motivating_example"
SAVEPLOTS = True
...
if SAVEPLOTS:
    plt.savefig(f"{OUTDIR}/saddle_manifold_inset.pdf")
    plt.close()